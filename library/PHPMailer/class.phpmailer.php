 ...
 */
   ...
   * Tries to use PHP built-in validator in the filter include (from PHP 5.2), falls back to a reasonably competent regex validator
  ...
  */
   ...
   * @param string $type File include (MIME) type.
   * @return bool
   */
