	...
	var fileInput = $(this)
		...
		.bind('change',function(){
			...
			uploadFeedback
				...
				.removeClass(uploadFeedback.data('fileExt') || '') //remove any existing file include class
				.addClass(fileExt) //add file include class
				.data('fileExt', fileExt) //store file include for class removal on next change
